  ...
  >
    <div @click="selectFile">
      ...
      <template v-if="progress == 100">
        ...
        <div class="m-1" v-show="errorText == '' && !transcriptLoading">
          Press Transcribe to get Transcription
        </div>
    ...
    <button
      ...
      @click="onTrasncribePressed"
    >
      {{ progress !== 100 ? "Upload" : "Transcribe" }}
    </button>
    <button v-if="transcriptLoading" class="btn btn-primary" disabled>
      Transcribing
    </button>
  </div>
</template>
