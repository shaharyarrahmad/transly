  ...
  <div>
    <section class="hero-section hero-bg">
      <div class="flex items-center p-4">
        <img src="/icon.svg" class="logo w-8 h-6" alt="logo" />
        <h1 class="text-white mb-0 ml-2 font-light md:text-4xl text-[28px]">
          Transly
        </h1>
      </div>
      ...
      <hr class="m-0" />
      <div
        class="mx-auto px-6 py-4 w-full container text-center"
        style="
          padding-left: calc(1.5rem * 0.5);
          padding-right: calc(1.5rem * 0.5);
        "
      >
        <p class="lead mb-6 md:text-4xl text-[28px] text-white font-bold">
      ...
      <template v-else-if="transcriptLoading">
        <div class="my-5">
          <div class="flex justify-center items-center">
            <div
              class="border-4 border-t-4 border-blue-500 rounded-full h-12 w-12 animate-spin"
              role="status"
            >
